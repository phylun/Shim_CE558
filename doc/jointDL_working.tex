...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){fig/fig1.png}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{fig/a1.png}}]{First A. Author} (M'76--SM'81--F'87) and all authors may include 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{fig/a2.png}}]{Second B. Author} was born in Greenwich Village, New York, NY, USA in 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{fig/a3.png}}]{Third C. Author, Jr.} (M'87) received the B.S. degree in mechanical 
