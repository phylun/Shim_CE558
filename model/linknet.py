...
class OwnLinkNet(nn.Module):
    ...
    def __init__(self, n_classes=21, No_feature=3):
        ...
        :type x_n: int
        """
        super(OwnLinkNet, self).__init__()
...
class OurLinkNet(nn.Module):
    ...
    def __init__(self, n_classes=21, No_feature=3):
        ...
        :type x_n: int
        """
        super(OurLinkNet, self).__init__()
